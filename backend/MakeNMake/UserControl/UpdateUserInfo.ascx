<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UpdateUserInfo.ascx.cs" Inherits="MakeNMake.UserControl.UpdateUserInfo" %>
    ...
    <div class="modal-content">
        ...
        <div style="margin-top:10px;">
            <div class="col-sm-12">
                ...
                <div class="col-sm-6 text-left linkBottom">
            <asp:Button ID="btnUPdateInfo" runat="server" OnClick="btnUPdateInfo_Click" ClientIDMode="Static" ValidationGroup="service" Text="Save Changes" 
