...
{
    public partial class ServiceEngineersReport : System.Web.UI.UserControl
    {
        ...
        {
            DataTable dtable = objAdmin.GetAllTicketsEngineerReportFilterbyDate(currentpage, UserName, fromdate, todate);
            return dtable;
        }
        DataTable GetBindData(int currentpage, string UserName)
        {
            DataTable dtable = objAdmin.GetAllTicketsEngineerReport(currentpage, UserName);
            return dtable;
        }
        protected void RptTickets_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
            {
                ...
                if (!string.IsNullOrEmpty(hdzoneid.Text))
                {
                ...
                if (!string.IsNullOrEmpty(hdsubzneid.Text))
                {
