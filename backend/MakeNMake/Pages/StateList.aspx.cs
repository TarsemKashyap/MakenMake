...
namespace MakeNMake.Admin
{
    public partial class StateList : System.Web.UI.Page
    {
        ...
        DataTable Getcnrtystat(int currentpage)
        {
            DataTable dtable = objAdmin.GetCountState(currentpage);
            return dtable;
        }
        private int GetCountryStatList()
        {
            pgsource.CurrentPageIndex = CurrentPage;
            DataTable dt = Getcnrtystat(CurrentPage);
        ...
        {
            Response.Redirect("Country-State.aspx");
        }
