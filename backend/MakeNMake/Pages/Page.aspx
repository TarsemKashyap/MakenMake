<%@ Page Title="Page" Language="C#" MasterPageFile="AdminMaster.Master" AutoEventWireup="true" CodeBehind="Page.aspx.cs" Inherits="MakeNMake.Admin.Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="panel panel-success">
        ...
        <div runat="server" id="divuser" class="panel-heading">
            <h3 class="panel-title paneltitle">Child Pages</h3>
        </div>
        ...
        <div class="panel-body">
            <div class="col-sm-12">
               ...
               <%-- <div class="col-sm-6 text-left linkBottom linkBottom">
                ...
                <div class="col-sm-6 text-left linkBottom">
                    <div class="input-group input-group-sm">
                        <span class="input-group-addon" id="Span5">Role</span>
                        <asp:DropDownList ID="ddlRole" runat="server"  CssClass="form-control  dropdown"></asp:DropDownList>
                    </div>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" InitialValue="0" runat="server" ControlToValidate="ddlParent"
                        ErrorMessage="Select Parent " ValidationGroup="user" Display="Dynamic" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                </div>
                <div class="col-sm-6 text-left linkBottom">
                    <div class="input-group input-group-sm">
                        <span class="input-group-addon" id="Span4">Parent Name</span>
                        <asp:DropDownList ID="ddlParent" runat="server" AutoPostBack="true"  CssClass="form-control  dropdown"></asp:DropDownList>
                    </div>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" InitialValue="0" runat="server" ControlToValidate="ddlParent"
                        ErrorMessage="Select Parent " ValidationGroup="user" Display="Dynamic" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                </div>
                <div class="col-sm-6 text-left linkBottom">
                    <div class="input-group input-group-sm">
                        <span class="input-group-addon" id="Span1">Page Name</span>
                        <asp:TextBox ID="txtpagename" placeholder=" Page Name" CssClass="form-control" runat="server"></asp:TextBox>
                    </div>
                </div>
                ...
                <div class="col-sm-6 text-left linkBottom">
                   ...
                   <div class="col-sm-6 text-left linkBottom">
                    <div class="input-group input-group-sm">
                        <span class="input-group-addon" id="Span6">Linked Pages</span>
                        <asp:TextBox ID="txtLinkeddescription" TextMode="MultiLine" placeholder="Title"  CssClass="form-control" runat="server"></asp:TextBox>
    ...
    <div class="panel panel-success">
        <div class="panel-heading">
            <h3 class="panel-title paneltitle">Page Description </h3>
        </div>
        <div class="panel-body">
        
            <div class="panel-heading" id="divpagelist" runat="server" style="padding-left: 0px;">
            <asp:HiddenField ID="hdnuserID" runat="server" />
                 <asp:HiddenField ID="hdnroleid" runat="server" />
            <table id="Table1" runat="server" align="center" width="100%" cellspacing="0" cellpadding="0">
            <tr>
                <td colspan="2" align="center">
            <asp:Repeater ID="RptAllpage" runat="server" OnItemCommand="RptAllpage_ItemCommand">
                <HeaderTemplate>
                    ...
                    <tbody>
                        <tr>  <td>
                            ...
                            <td>
                                ...
                                <asp:HiddenField ID="hdnChildID" runat="server" Value='<%#Eval("tblChildID") %>' />
                                
                                <asp:Label ID="lblParentname" runat="server" Text='<%#Eval("ParentName") %>'></asp:Label></td>
                            <td>
                                 <asp:Label ID="lblrolename" runat="server" Visible="false" Text='<%#Eval("RoleName") %>'></asp:Label>
                                <asp:Label ID="lblpagename" runat="server" Text='<%#Eval("PageName") %>'></asp:Label></td>
                            <td>
                                <asp:Label ID="lbldescription" runat="server" Text='<%#Eval("PageDescription") %>'></asp:Label>
                            </td>
                            <td>
                                <asp:Label ID="lbltitle" runat="server" Text='<%# Eval("PageTitle")%>'></asp:Label></td>
                            <td>
                                <asp:Label ID="lblLinkedPages" runat="server" Text='<%# Eval("LinkedPages")%>'></asp:Label></td>
                           
                            <td>
                                <asp:ImageButton ID="ImgBtnEdit" runat="server" Width="24" Height="24"
                                    ImageUrl="~/Static/images/edit.png" CommandName="edit" CommandArgument='<%#Eval("tblChildID") %>' />
                            </td>
                            <td>
                                <asp:ImageButton ID="ImgBtnDelete" OnClientClick="javascript:return DeleteConfirmation(this);"
                                    ...
                                    CommandName="delete" CommandArgument='<%#Eval("tblChildID") %>' />
                            </td>
                    </tbody>
                </ItemTemplate>
                <FooterTemplate>
