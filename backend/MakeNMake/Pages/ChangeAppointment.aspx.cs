...
namespace MakeNMake.Pages
{
    public partial class ChangeAppointment : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            {
                SentMailSmsRejected(Convert.ToInt64(AppointmentID), Convert.ToInt64(ddlEngineer.SelectedValue));
            }
            Response.Redirect("Appointments.aspx");
        }
        private void SentMailSmsRejected(Int64 ticketID, Int64 EngineerID)
        {
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                string message = "Hi, "+firstname+" ! Sorry! Your Appointment ticket Id: "+AppointmentID+" has been rejected due to insufficient information. Thanks for considering us & we hope to see you again. Please log in with your account details on our website ( www.makenmake.in)/Mobile App to see the status of the ticket.Or call us at Helpline Nos:"+ReadConfig.helpLineNumber;
                MEmail.SendGMail(emailid, "Make n Make", message, "");
