    ...
    public partial class Complaint : System.Web.UI.Page
    {
        ...
        protected void btnComplaint_Click(object sender, EventArgs e)
        {
            ...
            if (iSChecked)
            {
                ...
                else
                {
                    ...
                    int result = objComplaint.AddComplaint(Convert.ToInt64(Session[Constant.Session.AdminSession]), Convert.ToInt64(clientID), Convert.ToInt64(hdnAgreementID.Value), services.ToString(), ddlticket.SelectedValue, txtdesc.Text);
                    if (result > 0)
                    {
                        Clear();
                        ...
                        SentMailSms(Convert.ToInt64(clientID), result);
                       // Response.Redirect("Clients.aspx");
                        ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "Attention", "alert('Our service engineer will contact you as soon as possible .Your Ticket Number is :" + result.ToString() + " .Please save it for future communication.Email and sms sent to client') ;", true);
                    }
                    else if (result == -96)
                    {
        ...
        private void SentMailSms(Int64 UserID, Int64 ticketID)
        {
            ...
            if (dtcare1 != null && dtcare1.Rows.Count > 0)
            {
                ...
                string message1 = "Hi," + firstname + "! Your Service ticket Id: " + ticketID + " has been submitted.And Engineer Name is: " + engineerName + " . We will get back to you shortly.Please log in with your account details on our website ( www.makenmake.in)/Mobile App to see the status of the ticket.Or call us at Helpline Nos: "+ReadConfig.helpLineNumber;
            ...
            else
            {
                ...
                string message1 = "Hi," + firstname + "! Your Service ticket Id: " + ticketID + " has been submitted." + engineerName + " . We will get back to you shortly.Please log in with your account details on our website ( www.makenmake.in)/Mobile App to see the status of the ticket.Or call us at Helpline Nos: "+ReadConfig.helpLineNumber;
                SendSms objSms1 = new SendSms();
                try
                {
                    int i = objSms1.SendSmsOnMobile(message1, mobile);
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                ...
                if (dtcare != null && dtcare.Rows.Count > 0)
                {
                    ...
                    {
                        string message = "Hi," + engineerName + "! A new Service ticket Id: " + ticketID + " has been assigned to you. Please login to our website (www.makenmake.in)/Mobile App see the details.Or call us at Helpline Nos:"+ReadConfig.helpLineNumber;
                        ...
                        try
                        {
                            ...
                            MEmail.SendGMail(Convert.ToString(dtcare.Rows[0]["EmailID"]), "New Service Ticket Make 'N' Make",
                             "Dear " + engineerName + ",<br><br> A new Service ticket Id: " + ticketID + " has been assigned to you. Please login to our website (www.makenmake.in) /Mobile App see the details.Or call us at Helpline Nos:" + ReadConfig.helpLineNumber,"");
        ...
        //    if (dt != null && dt.Rows.Count > 0)
        //    {
        //        string message1 = "Hi," + firstname + "! Your Service ticket Id: " + ticketID + " has been submitted has been submitted . We will get back to you shortly. Please note that it takes maximum 24hrs to process a request .Please log in with your account details on our website ( www.makenmake.in) to see the status of the ticket. ";
        //        SendSms objSms1 = new SendSms();
        //        try
        //        {
        //            int i = objSms1.SendSmsOnMobile(message1, mobile);
        ...
        //                if (!string.IsNullOrEmpty(Convert.ToString(dtcare.Rows[0]["MobileNumber"])))
        //                {
        //                    string message = "Hi," + engineerName + "! A new Service ticket Id: " + ticketID + " has been assigned to you. Please login to our website (www.makenmake.in) see the details.";
        //                    MEmail.SendGMail(Convert.ToString(dtcare.Rows[0]["EmailID"]), "New Service Ticket Make 'N' Make", message, "");
        ...
        //                        }
        //                        MEmail.SendGMail(Convert.ToString(dtcare.Rows[0]["EmailID"]), "New Service Ticket Make 'N' Make",
        //                         "Dear " + engineerName + ",<br><br> A new Service ticket Id: " + ticketID + " has been assigned to you. Please login to our website (www.makenmake.in) see the details.", "");
        ...
        protected void ddlService_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                DataSet dt = objService.GetServiceAccordingToUser(Convert.ToInt64(clientID), ddlService.SelectedValue, Convert.ToInt32(ddlticket.SelectedValue));
                ...
                if (dt != null && dt.Tables[0].Rows.Count > 0)
                {
                    ...
                    else if (status == 0)
                    {
                        ...
                        ddlticket.SelectedValue = "0";
                        lblvalidationMsg.Visible = true;
                        lblvalidationMsg.Text = "Please give us a chance to serve you after buying our services .";
