...
{
    public partial class TicketHistoryViaTicketID : System.Web.UI.Page
    {
        Int64 ticketid;
        Int64 EngineerID;
        int TicketStatus;
        ...
        {
            DataTable dt = obj.BindAllEngineer(Convert.ToInt64(ViewState["TicketID"]),"Ticket");
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (result > 0)
            {
                //   ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "Attention", "alert('Ticket Assigned Successfully') ;", true);
                ...
                {
                    SentMailSms1(Convert.ToInt64(ViewState["TicketID"]), Convert.ToInt64(ddlEngineer.SelectedValue));
                }
                string TicketType = Convert.ToString(Request.QueryString["TicketType"]);
                int roleid = Convert.ToInt32(Session[Constant.Session.Role]);
                if (string.IsNullOrEmpty(TicketType) || TicketType == "")
            ...
            else
            {
                ...
                if (dtadmin.Rows.Count > 0)
                {
                    ...
                    message1 = "Hi,Admin Inspection & Quote Id " + ViewState["TicketID"] + " has been raised for your necessary action.";
                    ...
                    try
                    {
                        ...
                        if (i != 1)
                        {
                            ...
                            objAdmin.AddNotSendSmsMail(Convert.ToInt64(ViewState["Session_UserID"]), 0, "Ticket Status to Client", 1);
                        }
                    }
                    catch (Exception ex)
                    {
                        BL.BLAdmin objAdmin = new BL.BLAdmin();
                        objAdmin.AddNotSendSmsMail(Convert.ToInt64(ViewState["Session_UserID"]), 0, "Error while Ticket Status to Client-Issue:-" + ex.Message, 1);
                    }
                ...
                DataTable dtescaltion = care1.GetEsclationMnagerByTicketID(Convert.ToInt32(ViewState["TicketID"]));
                if (dtescaltion.Rows.Count > 0 && dtescaltion != null)
                {
                    string message1 = "";

                    message1 = "Hi," + dtescaltion.Rows[0]["EFirstName"] + "Inspection & Quote Id " + ViewState["TicketID"] + " has been raised for your necessary action.";
        ...
        private void SentMailSms(Int64 ticketID, Int64 EngineerID)
        {
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                ...
                if (dtcare != null && dtcare.Rows.Count > 0)
                {
                    ...
                    engno = Convert.ToString(dtcare.Rows[0]["MobileNumber"]);
                    string message = "Hi, " + firstname + "! Your Service ticket Id: " + ticketID + " has been assigned to Engineer "
                        + engineerName + " and his Mobile number is:"+engno + "He will serve you shortly. Please log in with your account details on our website (www.makenmake.in)/Mobile App to see the status of the ticket.";
                    ...
                    {
                        message = "Hi, " + firstname + "! Your Service ticket Id: " + ticketID + " has been assigned to Engineer "
                       + engineerName + " and his Mobile number is:" + engno + ".He will serve you shortly. Please log in with your account details on our website (www.makenmake.in)/Mobile App to see the status of the ticket.Or call us at Helpline Number:" + ReadConfig.helpLineNumber ;
                       ...
                       // message = "Hi," + "" + "! A new Service ticket Id: " + ticketID + " has been assigned to you. Please login to see the details.";
                        ...
                        MEmail.SendGMail(emailid, "Service Ticket Make 'N' Make", message, "");
                    }
                    else
                    {
                        }
            ...
            {
                string message = "Hi," + firstname + "! Your Service ticket Id: " + ticketID + " . We will serve you shortly.  You can log in with your account details on our website ( www.makenmake.in)/Mobile App to see the status of the ticket. Or call us at Helpline Nos : " + ReadConfig.helpLineNumber;
                SendSms objSms = new SendSms();
                try
                {
                    int i = objSms.SendSmsOnMobile(message, mobile);
        ...
        private void SentMailSms1(Int64 ticketID, Int64 EngineerID)
        {
            BLCustomerCare objSend = new BLCustomerCare();
            DataTable dt = objSend.GetUSerByTicketID(ticketID, 1);
            ...
            string message = "Hi, " + firstname + "! Sorry ! Your Appointment ticket Id: " + ticketID + "  has been rejected due to insufficient information. Thanks for considering us and we hope to see you again. Please log in with your account details on our website ( www.makenmake.in)/Mobile App to see the status of the ticket.Or call us at Helpline Nos:"+ReadConfig.helpLineNumber;
            SendSms objSms = new SendSms();
            try
            {
                int i = objSms.SendSmsOnMobile(message, mobile);
            ...
            MEmail.SendGMail(emailid, "Rejected Ticket Make 'N' Make", message, "");
