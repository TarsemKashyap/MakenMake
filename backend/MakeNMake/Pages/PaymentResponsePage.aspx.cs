...
namespace MakeNMake.Pages
{
    public partial class PaymentResponsePage : System.Web.UI.Page
    {
                    ...
                    //{
                        ...
                        if (txnStatus == "SUCCESS")
                        {
                            ...
                            if (result == 1)
                            {
                                ...
                                " or log in with your account details on our website (www.makenmake.in)/Mobile App .Please note that you can avail our services after one bussiness day of purchase.";
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            string ResponseParameterFromCitrus = EncryptDecrypt.DecryptText(Convert.ToString(Request.QueryString.Get("ResponseParameter")));
            string[] parameters = ResponseParameterFromCitrus.Split(':');
            string data = EncryptDecrypt.Encript(parameters[2] + ":" + parameters[4] + ":" + EncryptDecrypt.Encript(parameters[2]) + ":" + parameters[7] + ":" + parameters[8] + ":" + parameters[9] + ":" + parameters[1]);
