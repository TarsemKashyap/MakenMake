...
{
    public partial class EsclateTicketHistory : System.Web.UI.Page
    {
        Int64 ticketid;
        Int64 EngineerID;
        int TicketStatus;
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            int result = obj.AssignTicketToEnginner(Convert.ToInt64(ddlEngineer.SelectedValue), Convert.ToInt64(ViewState["Session_UserID"]), Convert.ToInt64(ViewState["TicketID"]), txtComments.Text, Convert.ToInt32(ddlStatus.SelectedValue));
            if (result > 0)
            {
