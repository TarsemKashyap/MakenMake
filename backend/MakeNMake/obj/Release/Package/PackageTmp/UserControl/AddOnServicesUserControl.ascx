<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddOnServicesUserControl.ascx.cs" Inherits="MakeNMake.UserControl.AddOnServicesUserControl" %>
...
<div class="col-md-6 text-left linkBottom" id="dvSubmit" runat="server" visible="false" style="padding: 0px;">
    <asp:Button ID="btnProceedToPayment" runat="server" CssClass="btn btn-success" OnClientClick="javascript:return CheckValid();"    ClientIDMode="Static"  Text="View Benefits" OnClick="btnProceedToPayment_Click" />
</div>
<script type="text/javascript">
    function CheckValid() {
        var isUncheck = false;
