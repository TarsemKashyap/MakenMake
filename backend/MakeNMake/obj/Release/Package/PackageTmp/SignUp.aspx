...
background-position:left;">
                 ...
                 <%--  <div class="col-lg-10" style="height:30px;align-items:center;"></div>--%>
                    ...
                    <div id="contactform">
                        ...
                        <asp:TextBox ID="txtlastName" ClientIDMode="Static" type="text" placeholder="Enter LastName" AutoCompleteType="None" onkeypress="return ValidateCharacters(event)" autocomplete="off" runat="server" class=""></asp:TextBox>
                        ...
                        <asp:RegularExpressionValidator ID="Regex2" runat="server" Display="Dynamic" ForeColor="Red" ControlToValidate="txtpass" ValidationGroup="signup"
                            ValidationExpression="^(?=.*[A-Za-z])(?=.*\d)(?=.*[$@$!%*#?&])[A-Za-z\d$@$!%*#?&]{4,}$"
                            ErrorMessage="*" />
                        <br /><br />
                        <p class="contact">
                        ...
                        <br /><br />
                        <p class="contact">
                            <label for="phone">Gender(Not Mandatory)
</label>
                        </p>
                       ...
                       <%-- <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ErrorMessage="Enter Gender" ValidationGroup="signup"
                        ...
                        Day:<asp:TextBox ID="txtday" runat="server" Width="40px" MaxLength="2" placeholder="DD" />
                      <%--  <asp:RegularExpressionValidator ID="RegularExpressionValidator3" SetFocusOnError="true" runat="server" ControlToValidate="txtday" 
                        ...
                        --%>
                        Year:<asp:TextBox ID="txtDob" runat="server" Width="68px" MaxLength="4" placeholder="YYYY" />
                        <%--<fieldset>
                        <asp:DropDownList ID="ddlmonth" runat="server">
                       ...
                       <%-- <p class="City">
                        ...
                        <div class="demo3" style="padding-left: 31px; width: 85%;">
                            <div class="demo4" style="text-align: center; padding-top: 15px;">
                                <asp:RadioButtonList ID="rdbServices" CssClass="" RepeatLayout="Table" RepeatDirection="Horizontal" runat="server" Width="290px">
